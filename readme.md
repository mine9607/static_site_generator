...
Users cannot: - Upload files - Log in - Leave comments - Save preferences

HTML is a tree-like structure where each "tag" can contain other tags.

Static sites are good for: - Blogs - Portfolios - Landing pages - Documentation
...
3.  The `LeafNode` value member MUST BE REQUIRED
    ...
    Ex: The super.**init**(tag, value, [], props) - need to pass an empty children list
